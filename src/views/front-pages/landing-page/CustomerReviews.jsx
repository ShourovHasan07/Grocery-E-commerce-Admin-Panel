...
const data = [
  {
    desc: "I've never used a theme as versatile and flexible as AskValor. It's my go to for building dashboard sites on almost any project.",
  ...
  return (
    <section
      className={classnames(
        "flex flex-col gap-8 plb-[100px] bg-backgroundDefault",
