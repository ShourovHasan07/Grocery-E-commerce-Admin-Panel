...
const FormLayoutsWithTabs = () => {
  ...
  const handleClickShowPassword = () =>
    setFormData((show) => ({
      ...show,
      isPasswordShown: !show.isPasswordShown,
    }));

  const handleClickShowConfirmPassword = () =>
    setFormData((show) => ({
      ...show,
      setIsConfirmPasswordShown: !show.setIsConfirmPasswordShown,
    }));
              ...
              <Grid container spacing={6}>
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                  <CustomTextField
                    ...
                    type={
                      formData.setIsConfirmPasswordShown ? "text" : "password"
                    }
                        ...
                        endAdornment: (
                          <InputAdornment position="end">
                            ...
                            >
                              <i
                                className={
                                  formData.setIsConfirmPasswordShown
                                    ? "tabler-eye-off"
                                    : "tabler-eye"
                                }
                              />
              ...
              <Grid container spacing={6}>
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                  <CustomTextField
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, quora: e.target.value })
                    }
                  />
                </Grid>
              </Grid>
