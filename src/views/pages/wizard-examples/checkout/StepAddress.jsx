...
const data = [
  {
    ...
    content: (
      <HorizontalContent
        component="div"
        className="flex flex-col gap-3 mbs-2 bs-full"
      >
    ...
    content: (
      <>
        <Chip
          ...
          label="Free"
          color="success"
          className="absolute inline-end-4"
        />
          ...
          <Grid container spacing={6}>
            {dataIcons.map((item, index) => {
              ...
              if (item.asset && typeof item.asset === "string") {
                asset = (
                  <i className={classnames(item.asset, "text-[28px] mbs-3")} />
                );
              }
              ...
              return (
                <CustomInputVertical
                  ...
                  data={
                    typeof item.asset === "string" ? { ...item, asset } : item
                  }
                />
              );
            })}
          ...
          <CardContent className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4">
              <img
                width={60}
                height={60}
                src="/images/pages/google-home.png"
                alt="Google Home"
              />
              <div>
            ...
            <div className="flex items-center gap-4">
              <img
                width={60}
                height={60}
                src="/images/pages/iPhone-11.png"
                alt="iphone 11"
              />
              <div>
