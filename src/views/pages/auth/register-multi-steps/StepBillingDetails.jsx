...
const customInputData = [
  {
    ...
    content: (
      <Content
        component="div"
        className="flex flex-col justify-center items-center bs-full gap-2"
      >
        ...
        <div className="flex items-baseline">
          ...
          <Typography
            component="sub"
            className="self-baseline text-textDisabled"
          >
            /month
          </Typography>
        </div>
...
const StepBillingDetails = ({ handlePrev }) => {
  const initialSelectedOption = customInputData.filter(
