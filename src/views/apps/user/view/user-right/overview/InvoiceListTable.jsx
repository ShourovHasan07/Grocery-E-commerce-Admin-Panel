            ...
            >
              <i
                className={classnames(
                  "text-base",
                  invoiceStatusObj[row.original.invoiceStatus].icon,
                )}
              />
            </CustomAvatar>
          </Tooltip>
        ...
        cell: ({ row }) => (
          <div className="flex items-center">
            <IconButton
              onClick={() =>
                setData(
                  data?.filter((invoice) => invoice.id !== row.original.id),
                )
              }
            >
            ...
            <OptionMenu
              ...
              options={[
                ...
                },
                {
                  ...
                  linkProps: {
                    className: classnames(
                      "flex items-center bs-[40px] plb-2 pli-4 is-full gap-2 text-textSecondary",
                    ),
                  },
                },
                {
            ...
            {table.getHeaderGroups().map((headerGroup) => (
              <tr key={headerGroup.id}>
                {headerGroup.headers.map((header) => (
                  <th
                    key={header.id}
                    {...(header.id === "action" && { className: "is-24" })}
                  >
