...
const categoryData = [
  ...
  },
  {
    ...
    description:
      "Explore beauty and personal care products, shop makeup and etc.",
    totalProduct: 9474,
    totalEarning: 74829,
  ...
  },
  {
    ...
    categoryTitle: "Books",
    description:
      "Over 25 million titles across categories such as business  and etc.",
    totalProduct: 10257,
    totalEarning: 63618,
  ...
  },
  {
    ...
    categoryTitle: "Games",
    description:
      "Every month, get exclusive in-game loot, free games, a free subscription.",
    totalProduct: 14501,
    totalEarning: 65920,
  ...
  },
  {
    ...
    description:
      "Buy baby products across different categories from top brands.",
    totalProduct: 8624,
    totalEarning: 38838,
  ...
  },
  {
    ...
    description:
      "Enhance your computing experience with our range of computer accessories.",
    totalProduct: 9876,
    totalEarning: 65421,
  ...
  },
  {
    ...
    description:
      "Immerse yourself in rich audio quality with our wide range of speakers.",
    totalProduct: 5678,
    totalEarning: 32145,
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("totalProduct", {
        ...
        cell: ({ row }) => (
          <Typography>{row.original.totalProduct.toLocaleString()}</Typography>
        ),
      }),
      columnHelper.accessor("totalEarning", {
        ...
        cell: ({ row }) => (
          <Typography>
            {row.original.totalEarning.toLocaleString("en-IN", {
              style: "currency",
              currency: "USD",
            })}
          </Typography>
