          ...
          <Grid size={{ xs: 12, sm: 6, md: 4 }}>
            <div className="border rounded bs-full">
              ...
              <div className="flex flex-col gap-2 p-6">
                ...
                <Typography>
                  The Fender Acoustic Guitar is the best choice for both
                  beginners and professionals offering a great sound.
                </Typography>
              </div>
            </div>
          </Grid>
