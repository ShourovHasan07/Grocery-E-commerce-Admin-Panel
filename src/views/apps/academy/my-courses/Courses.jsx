  ...
  useEffect(() => {
    ...
    if (searchValue) {
      newData = newData.filter((category) =>
        category.courseTitle.toLowerCase().includes(searchValue.toLowerCase()),
      );
    }
      ...
      <CardContent className="flex flex-col gap-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-y-4 gap-x-6">
            ...
            <FormControlLabel
              control={
                <Switch onChange={handleChange} checked={hideCompleted} />
              }
                    ...
                    <div className="flex flex-col gap-4 p-5">
                      <div className="flex items-center justify-between">
                        <Chip
                          ...
                          variant="tonal"
                          size="small"
                          color={chipColor[item.tags].color}
                        />
                        <div className="flex items-start">
                          <Typography className="font-medium mie-1">
                            {item.rating}
                          </Typography>
