...
const TimeSlots = ({ expertData }) => {
  ...
  return (
    <Card>
      <CardHeader title="Expert Time Slots" className="pb-1" />
      <CardContent>
        <Grid size={{ xs: 12 }}>
          <div className="w-full overflow-x-auto">
            <TableContainer component={Paper}>
              <Table>
                <TableHead>
                  <TableRow>
                    <TableCell colSpan={2} className="font-black text-[15px]">
                      Day
                    </TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {expertData?.availabilities &&
                    expertData?.availabilities.length > 0 &&
                    expertData.availabilities.map((group) => (
