    ...
    return (
      <div
        className={classnames(
          "bs-full overflow-x-hidden overflow-y-auto",
          className,
        )}
      >
        {children}
...
const UserProfileRight = (props) => {
  // Props
  const { open, handleClose, activeUser, isBelowLgScreen, isBelowSmScreen } =
    props;
  ...
  return activeUser ? (
    ...
    >
      ...
      <ScrollWrapper
        ...
        className="flex flex-col gap-6 p-6 pbs-3"
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <List className="plb-0">
            <ListItem className="p-2 gap-2">
              ...
              <ListItemText
                primary={`${activeUser.fullName.toLowerCase().replace(/\s/g, "_")}@email.com`}
              />
            </ListItem>
            <ListItem className="p-2 gap-2">
              <ListItemIcon>
