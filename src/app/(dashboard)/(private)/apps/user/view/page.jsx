...
const OverViewTab = dynamic(
  () => import("@views/apps/user/view/user-right/overview"),
);

const SecurityTab = dynamic(
  () => import("@views/apps/user/view/user-right/security"),
);

const BillingPlans = dynamic(
  () => import("@views/apps/user/view/user-right/billing-plans"),
);

const NotificationsTab = dynamic(
  () => import("@views/apps/user/view/user-right/notifications"),
);

const ConnectionsTab = dynamic(
  () => import("@views/apps/user/view/user-right/connections"),
);
