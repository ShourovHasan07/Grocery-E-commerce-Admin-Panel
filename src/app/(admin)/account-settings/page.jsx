...
const AccountTab = dynamic(
  () => import("@views/pages/account-settings/account"),
);

const SecurityTab = dynamic(
  () => import("@views/pages/account-settings/security"),
);

const BillingPlansTab = dynamic(
  () => import("@views/pages/account-settings/billing-plans"),
);

const NotificationsTab = dynamic(
  () => import("@views/pages/account-settings/notifications"),
);

const ConnectionsTab = dynamic(
  () => import("@views/pages/account-settings/connections"),
);
